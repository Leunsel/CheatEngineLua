...
registerLuaFunctionHighlight('ToggleSmoothTeleport')
...
registerLuaFunctionHighlight('CalculateDistance3D')
...
registerLuaFunctionHighlight('SmoothTeleport')
...
registerLuaFunctionHighlight('GetCurrentCoordinates')
...
registerLuaFunctionHighlight('WriteSavesToFile')
...
registerLuaFunctionHighlight('ReadSavesFromFile')
...
registerLuaFunctionHighlight('CreateTeleportMemoryRecord')
